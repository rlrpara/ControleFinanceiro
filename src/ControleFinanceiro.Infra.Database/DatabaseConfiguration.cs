...
using ControleFinanceiro.Infra.Database.Interface;
using Dapper;
using System.Data;
using System.Text;
...
public class DatabaseConfiguration : DatabaseConfigurationBase, IDatabaseConfiguration
{
    ...
    private readonly string? _pastaBanco;
    #endregion
    ...
    private bool ServidorAtivo()
    {
        try
        {
            ...
            using var conexao = ConnectionConfiguration.AbrirConexao(ObterParametrosConexao(false));
